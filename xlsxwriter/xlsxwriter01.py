...
workbook = xlsxwriter.Workbook('deomo1.xlsx')    #创建一个Excel文件
...
worksheet.write(3, 0, 35.5)  #行列表示法的单元格小标以0作为起始值， '3, 0' = 'A4'
worksheet.write(4, 0, '=SUM(A3:A4)')   #求A3:A4的和，并将结果写入'4, 0', 即'A5'

worksheet.insert_image('B5', 'img/HZ-WebEx-ENV-ARC.png')   #在B5单元格插入图片
